...
const LoginForm = ({setStatus1, setStatus2, setFlag}: Status) => {
  ...
  return (
<main className='bg-white w-96 p-4' style={{fontFamily:'IBM Plex Sans'}}>
         <form action="">
        <div className='flex justify-between'>
         <p className='w-32 h-6 font-bold leading-6 text-lg'>Welcome Back!</p>
        ...
        <div className='flex justify-between mt-5 mb-5 pl-4 pr-4'>
          <button className='bg-blue-800 text-white rounded-2xl font-semibold text-sm w-32 h-9'>Sign In</button>
          <p className='underline' onClick={handleClickCreate}>or, Create Account</p>
        </div>
       ...
       <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className='w-5 h-5'>
        ...
        <div>
          <p className='w-60 text-xs leading-4 m-auto text-center tracking-tight'>Forgot Password?</p>
        </div>
      </form>
    </main>
  )
